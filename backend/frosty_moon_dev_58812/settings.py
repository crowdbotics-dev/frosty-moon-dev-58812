"""
Django settings for frosty_moon_dev_58812 project.
...
ROOT_URLCONF = 'frosty_moon_dev_58812.urls'
...
WSGI_APPLICATION = 'frosty_moon_dev_58812.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_moon_dev_58812 API",
    "DESCRIPTION": "API documentation for frosty_moon_dev_58812 App",
    "VERSION": "v1",
}
